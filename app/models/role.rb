...
class Role < ApplicationRecord
  ...
  def self.create_default_roles(provider)
    ...
    Role.create(name: "admin", provider: provider, priority: 0, colour: "#f1c40f")
      ...
      can_edit_roles: true, can_manage_users: true, can_manage_companies: true)
    ...
    Role.create(name: "super_admin", provider: provider, priority: -3, colour: "#cd201f")
      ...
      can_edit_roles: true, can_manage_users: true, can_manage_rooms_recordings: true, can_manage_companies: true)
  end
  ...
  def update_all_role_permissions(permissions = {})
    ...
    update_permission("can_manage_companies", permissions[:can_manage_companies].to_s)
